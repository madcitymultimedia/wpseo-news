		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					...
					<p class="expl">
						Generated by <a href="https://yoa.st/1y5">Yoast</a> <a href="https://yoa.st/1y6">SEO</a> and its <a href="https://yoa.st/4hj">Google News SEO module</a>, this is an XML News Sitemap, meant for consumption by Google News.
					</p>
					<p class="expl">
